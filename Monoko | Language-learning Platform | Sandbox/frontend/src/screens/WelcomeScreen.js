...
const WelcomeScreen = ({ navigation }) => {
  ...
  const languages = [
    { name: 'Swahili', character: <LanguageCharacter language="sw" size={32} />, speakers: '200M+', color: colors.swahili },
    { name: 'Lingala', character: <LanguageCharacter language="ln" size={32} />, speakers: '70M+', color: colors.lingala },
    { name: 'Amharic', character: <LanguageCharacter language="am" size={32} />, speakers: '57M+', color: colors.amharic },
  ];
              ...
              <View style={styles.logoContainer}>
                <View style={styles.logoRow}>
                  ...
                  <View style={styles.logoIcon}>
                    <GuideCharacter type="welcome" size={44} color={colors.primaryLight} />
                  </View>
