...
export const colors = {
  ...
  primary: '#4CAF50',        // Logo green (matches uploaded logo)
  primaryLight: '#66BB6A',   // Light green for backgrounds
  primaryDark: '#388E3C',    // Dark green for emphasis
  
  // Brand identity colors
  logoGreen: '#4CAF50',      // Exact logo color
  brandGreen: '#4CAF50',     // Primary brand color
  speechBubble: '#4CAF50',   // Speech bubble color
  
  // Secondary colors - complementary to logo green
  secondary: '#FF6B35',      // Warm orange (complementary)
  secondaryLight: '#FF8A65', // Light orange
  secondaryDark: '#F4511E',  // Dark orange
